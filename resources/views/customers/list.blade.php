                ...
                @else
                    @foreach($customers as $key => $customer)
                        <tr>
                            ...
                            <td><a href="{{ route('customers.destroy', $customer->id) }}" class="text-danger" onclick="return confirm('Bạn chắc chắn muốn xóa {{$customer->name}} khong?')">{{__('messages.delete')}}</a></td>
                        </tr>
                    @endforeach
                @endif
                </tbody>
